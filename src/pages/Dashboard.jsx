      ...
      <main className="admin-main">
        ...
        <div className="admin-cards">
          <div className="admin-card">
            <div className="card-label">Registered Athletes</div>
            <div className="card-value">{users?.totalUsers?.toLocaleString()}</div>
            <div className="card-delta">↑ {STATS.usersToday} today</div>
          </div>

          <div className="admin-card">
            <div className="card-label">Registered Today</div>
            <div className="card-value">{users?.usersToday}</div>
            <div className="card-delta">↑ 12% vs yesterday</div>
          </div>

          <div className="admin-card">
            <div className="card-label">Total Matches</div>
            <div className="card-value">0</div>
            <div className="card-delta">↑ 8 scheduled today</div>
          </div>
        </div>
